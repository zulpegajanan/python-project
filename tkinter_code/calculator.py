...
# root = Tk()
#
# root.title("simple calculator from gajanan zulpe")
# e=Entry(root, width=33,borderwidth=8)
...
# beq=Button(root,text="=",padx=40,pady=20,bg="yellow",command=lambda :button_click)
# badd=Button(root,text="+",padx=40,pady=20,bg="yellow",command=lambda :button_click)
# bclear=Button(root,text="clear",padx=31,pady=20,bg="orange",command=lambda :button_click))
